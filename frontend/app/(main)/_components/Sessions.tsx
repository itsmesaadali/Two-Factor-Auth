...
const Sessions = () => {
  ...
  const handleDelete = useCallback((id: string) => {
    mutate(id, {
      onSuccess: () => {
        refetch();
        toast.success("Session remove", {
          description: "Session remove successfully",
        });
      },
      onError: (error: any) => {
        toast.error("Session remove faild", {
          ...
          <div className="rounded-t-xl max-w-xl">
            <div>
              ...
              <p className="mb-6 text-sm text-[#0007149f] dark:text-gray-100">
                You’re logged into this MERN account on this device and are
                currently using it.
              </p>
            </div>
            <div className="w-full">
              ...
              <div className="mt-4">
                ...
                <ul className="mt-4 w-full spacy-3 max-h-[400px] overflow-y-auto">
